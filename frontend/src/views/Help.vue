<template>
  <el-dialog
    ...
    <span slot="footer" class="dialog-footer">Version: {{thisPackage.version}} | Author: {{thisPackage.author}} |
      View source: <a :href="thisPackage.git" target="_blank">GitHub</a></span>
  </el-dialog>
</template>
